...
public class CircleProgressButton extends View {
    ...
    private boolean isVideoing = false; // 是否錄影中
    ...
    public boolean onTouchEvent(MotionEvent event) {
        switch (event.getAction()) {
            case MotionEvent.ACTION_DOWN:
                Log.d("more", "CircleProgressButton, ACTION_DOWN");
                if (mListener != null && !mListener.onPreProgress(this)) {
                    Log.d("more", "CircleProgressButton, ACTION_DOWN2");
                    return true;
                }
                Log.d("more", "CircleProgressButton, ACTION_DOWN3");
                mState = State.PRESSED;
                startProgressAnimator();
                return true;
            case MotionEvent.ACTION_UP:
                Log.d("more", "CircleProgressButton, ACTION_UP");
                // releaseProgress(true);
                //消除警告
                // performClick();
                return true;
            case MotionEvent.ACTION_CANCEL:
                Log.d("more", "CircleProgressButton, ACTION_CANCEL");
    ...
    public boolean performClick() {
        Log.d("more", "CircleProgressButton, performClick");
        //消除警告
    ...
    private void startProgressAnimator() {
        ...
        if (mTimerMode) {
            Log.d("more", "CircleProgressButton, startProgressAnimator(), " +
                    "setDuration: " + mMaxProgress * 1000);
